...
export const packs = [
  { name: "Starter", icon: "M12 3.5 19 8v8l-7 4.5L5 16V8z M12 12v8.5M12 12 5 8M12 12l7-4", fit: "2 days/week · 15–40 users", positioning: "For organisations ready to professionalise IT without a full-time commitment.", inclusions: ["2 days/week on-site engineer", "Dedicated on-site support (2-days/week)", "Remote Support & Monthly ticket KPI Reports", "Monthly vCIO review & Strategic Advisory", "IT Audit & IT Help Desk System inclusive"] },
  { name: "Growth", icon: "M3.5 20.5V14M9.2 20.5V9.5M14.9 20.5v-7M20.5 20.5V4.5M3.5 10.5l5.7-4 5.7 3 5.6-5", fit: "3 days/week · 40–80 users", positioning: "For growing organisations running several systems, ERP dependencies or distributed operations.", inclusions: ["3 days/week on-site engineer", "IT Operations Lead oversight", "Fortnightly vCIO Advisory", "Custom Automation review", "Deeper ERP input", "Includes everything in Starter"] },
