    ...
    <footer className="bg-[#071e1b] px-5 pb-[32px] pt-[56px] sm:px-8 lg:px-[64px] lg:pt-[64px]">
      <div className="grid grid-cols-1 gap-[40px] pb-[48px] sm:grid-cols-2 lg:grid-cols-[1.4fr_1fr_1fr_1fr] lg:gap-[48px] lg:pb-[56px]">
        ...
        <div className="flex flex-col items-start gap-[16px]">
          ...
          <a href={routes.companyProfile} target="_blank" rel="noopener" aria-label="View and download the company profile" className="mt-[14px] inline-flex items-center gap-[8px] font-inter text-[13.5px] font-medium text-[#c7d0dc] underline underline-offset-[3px] [text-decoration-thickness:1px] hover:text-[#9EFF5A]">
