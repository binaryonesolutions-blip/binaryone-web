  ...
  const contactCard = (
    <div className="flex items-stretch gap-[16px] sm:gap-[22px] rounded-[16px] border border-[rgba(56,224,196,0.75)] bg-[#d9f5ef] p-[22px] sm:p-[32px] shadow-[0_0_0_1px_rgba(56,224,196,0.18),0_0_28px_rgba(56,224,196,0.30),0_18px_40px_-30px_rgba(6,35,30,0.35)]">
      ...
      <div className="flex flex-1 flex-col gap-[16px]">
        ...
        <p className="font-inter text-[15px] leading-[1.75] text-[#2c4b46]"><a href="tel:+254787990220" className="text-[#2c4b46] underline underline-offset-[2px] hover:text-[#06332e]">+254 787 990 220</a><br /><a href="mailto:info@binaryone.co.ke" className="text-[#2c4b46] hover:text-[#06332e]">info@binaryone.co.ke</a></p>
      ...
      <div className="flex flex-col gap-[20px]">
        ...
        <div className="overflow-hidden rounded-[16px] border border-[#E5E7EB] bg-white shadow-[0_1px_2px_rgba(6,35,30,0.05),0_18px_40px_-30px_rgba(6,35,30,0.35)]">
          <div className="flex items-center justify-between gap-[12px] border-b border-[#E5E7EB] px-[16px] py-[12px]">
            ...
            <a href="https://www.google.com/maps/search/?api=1&query=PQ2W%2BJX7%2C+Ngong+Rd%2C+Nairobi" target="_blank" rel="noopener" className="whitespace-nowrap font-inter text-[12px] font-semibold text-[#0f766e] hover:text-[#12897f]">Open in Maps ↗</a>
          </div>
