...
export default function DataProtectionPage() {
  return (
    <div data-skin="policy" className="mx-auto w-[1440px] bg-[#F8FAFB] font-inter text-[#1c1b1b]">
      <SiteHeader solid />

      {/* Hero */}
      <section className="relative overflow-hidden bg-[#0c1c2b] px-[64px] py-[72px]">
        ...
        <div className="relative flex items-start justify-between gap-[40px]">
          <div className="max-w-[720px]">
            ...
            <p className="max-w-[620px] font-inter text-[16.5px] leading-[1.6] text-[#93a4b3] [text-wrap:pretty]">Demonstrating our strict commitment to the Kenya Data Protection Act, 2019. We implement boardroom-grade security controls to safeguard client information assets.</p>
          </div>
