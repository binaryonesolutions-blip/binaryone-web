  ...
  return (
    <div data-skin="policy" className="mx-auto w-full max-w-[1440px] overflow-x-hidden bg-[#F8FAFB] font-inter text-[#1c1b1b]">
      ...
      <section className="relative overflow-hidden bg-[#0c1c2b] px-5 sm:px-8 lg:px-[64px] py-[72px]">
        ...
        <div className="relative flex flex-col gap-[24px] lg:flex-row lg:items-start lg:justify-between lg:gap-[40px]">
          ...
          <div className="flex flex-shrink-0 items-center gap-[12px] self-start rounded-[14px] border border-white/10 bg-white/[0.04] px-[20px] py-[16px]">
