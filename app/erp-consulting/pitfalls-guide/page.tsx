...
export default function ErpPitfallsPage() {
  return (
    <div data-skin="corporate" className="mx-auto w-[1440px] bg-[#F8FAFB] font-inter text-[#1c1b1b]">
      {/* Minimal header */}
      <header className="sticky top-0 z-50 flex h-[76px] items-center justify-between border-b border-[#E0E5E6] bg-[rgba(237,241,242,0.94)] px-[64px] [backdrop-filter:blur(12px)]">
        ...
        <div className="flex items-center gap-[28px]">
          <Link href={routes.erp} className="inline-flex items-center gap-[9px] font-inter text-[15px] font-medium text-[#1c1b1b] hover:text-[#0f766e]"><span className="text-[16px]">←</span>Back to ERP Consulting</Link>
      ...
      {/* Cover */}
      <section className="relative overflow-hidden bg-[#071e1b] px-[64px] pb-[72px] pt-[88px]">
        ...
        <div className="relative grid grid-cols-[1.15fr_0.85fr] items-center gap-[64px]">
          <div>
            ...
            <h1 className="mb-[22px] font-sora text-[60px] font-extrabold leading-[1.05] tracking-[-0.03em] text-white [text-wrap:pretty]">The ERP <span className="text-[#38e0c4]">Pitfalls</span> Guide</h1>
            <p className="mb-[30px] max-w-[600px] font-inter text-[18px] leading-[1.7] text-[#c2dbd7] [text-wrap:pretty]">Seven ways ERP programmes quietly go wrong in East Africa — what each one looks like from the inside, what it costs, and the antidote we apply before a single licence is signed.</p>
      ...
      {/* How to read */}
      <section className="border-b border-[#E5E7EB] bg-white px-[64px] py-[80px]">
        <div className="grid grid-cols-[0.9fr_1.1fr] items-start gap-[64px]">
          <div>
      ...
      {/* Pitfalls */}
      <section className="px-[64px] pb-[40px] pt-[88px]">
        <h2 className="mb-[8px] font-sora text-[38px] font-bold leading-[1.15] tracking-[-0.02em] text-[#1c1b1b]">Seven pitfalls.</h2>
        <p className="mb-[52px] font-inter text-[16.5px] text-[#6e7977]">Symptom · what it costs · the antidote.</p>
        <div className="flex flex-col gap-[28px]">
          {pitfalls.map((p) => (
            <div key={p.id} id={p.id} className="grid grid-cols-[120px_1fr] gap-[32px] rounded-[16px] border border-[#E5E7EB] border-l-4 border-l-[#0f766e] bg-white px-[40px] py-[36px] shadow-[0_1px_2px_rgba(15,23,42,0.04)] transition-[box-shadow,transform] hover:-translate-y-[2px] hover:shadow-[0_14px_34px_rgba(15,118,110,0.12)]">
              <div>
                <span className="block font-sora text-[46px] font-extrabold leading-[1] tracking-[-0.03em] text-[#e3f5f1]">{p.num}</span>
      ...
      {/* Self-check */}
      <section id="self-check" className="mt-[48px] bg-[#0c1512] px-[64px] py-[88px] [scroll-margin-top:90px]">
        <div className="grid grid-cols-[0.85fr_1.15fr] items-stretch gap-[56px]">
          <div className="flex flex-col">
            ...
            <p className="mb-[26px] font-inter text-[16.5px] leading-[1.7] text-[#c2dbd7] [text-wrap:pretty]">Six or more and you are ready to talk to vendors. Four or five and you need a scoping exercise first. Three or fewer and choosing software now is the most expensive thing you could do.</p>
            ...
            <a href={routes.enquiry} className="mt-auto inline-flex items-center gap-[10px] self-center rounded-[12px] bg-[#38e0c4] px-[30px] py-[16px] font-inter text-[15.5px] font-bold text-[#06231e] hover:bg-[#5ceace] hover:text-[#06231e]">Score it with a consultant<span className="text-[16px]">→</span></a>
          </div>
          <ErpSelfCheck />
        </div>
      </section>
      ...
      {/* Counter-programme */}
      <section id="counter-programme" className="bg-white px-[64px] py-[88px]">
        <span className="mb-[18px] block font-jet text-[12px] font-bold tracking-[0.22em] text-[#0f766e]">THE COUNTER-PROGRAMME</span>
        <h2 className="mb-[12px] font-sora text-[38px] font-bold leading-[1.15] tracking-[-0.02em] text-[#1c1b1b]">Six stages that remove the pitfalls.</h2>
        <p className="mb-[52px] max-w-[720px] font-inter text-[16.5px] text-[#6e7977] [text-wrap:pretty]">Our ERP consulting sequence exists because every stage closes one of the seven pitfalls above before it can cost money.</p>
        <div className="grid grid-cols-3 gap-[24px]">
          {stages.map((s) => (
            <div key={s.num} className="rounded-[16px] border border-[rgba(15,118,110,0.18)] p-[30px] shadow-[0_1px_2px_rgba(15,118,110,0.06)] [background:linear-gradient(160deg,#ffffff_0%,#f6fcfa_60%,#e9f6f3_100%)]">
              ...
              <span className="mb-[10px] block font-sora text-[19px] font-bold text-[#1c1b1b]">{s.name}</span>
      ...
      {/* CTA */}
      <section className="bg-[#F8FAFB] px-[64px] py-[96px] text-center">
        ...
        <p className="mx-auto mb-[36px] max-w-[620px] font-inter text-[16.5px] leading-[1.7] text-[#6e7977] [text-wrap:pretty]">A scoping session is vendor-neutral, evidence-first and costs you nothing but an honest hour.</p>
        <div className="flex justify-center gap-[16px]">
          <Link href={routes.enquiry} className="inline-block rounded-[12px] bg-[#38e0c4] px-[32px] py-[16px] font-inter text-[16.5px] font-semibold text-[#06231e] shadow-[0_1px_2px_rgba(15,118,110,0.2)] hover:bg-[#5ceace] hover:text-[#06231e]">Request a Scoping Session</Link>
          <Link href={routes.erp} className="inline-block rounded-[12px] border-[1.5px] border-[rgba(15,118,110,0.35)] bg-white px-[30px] py-[14.5px] font-inter text-[16.5px] font-semibold text-[#0f766e] hover:bg-[#f2fbf9] hover:text-[#0b5f58]">Back to ERP Consulting</Link>
        </div>
      </section>
