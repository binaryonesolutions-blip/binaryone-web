  ...
  return (
    <div data-skin="corporate" className="mx-auto w-[1440px] bg-[#F8FAFB] text-[#1c1b1b] [font-family:var(--font-inter)]">
      ...
      <div className="relative overflow-hidden [background:linear-gradient(180deg,#071e1b_0%,#0a2724_48%,#6f8f86_78%,#F8FAFB_100%)]">
        ...
        <div className="relative grid grid-cols-[1.1fr_0.9fr] items-center gap-[64px] px-[64px] pb-[80px] pt-[88px]">
          <div>
            ...
            <h1 className="mb-[30px] font-sora text-[54px] font-bold leading-[1.16] tracking-[-0.02em] text-white [text-wrap:pretty]">
            ...
            <div className="mb-[44px] flex items-center gap-[20px]">
              <Link href={routes.erpPitfalls} className="inline-flex items-center gap-[12px] rounded-[14px] bg-[#38e0c4] px-[30px] py-[17px] font-inter text-[16px] font-bold text-[#0c1512] shadow-[0_8px_24px_rgba(56,224,196,0.25)] hover:bg-[#5ceace]">
              ...
              <Link href={routes.contact} className="inline-block rounded-[14px] border-[1.5px] border-[rgba(56,224,196,0.5)] bg-[rgba(255,255,255,0.06)] px-[28px] py-[15.5px] font-inter text-[16px] font-semibold text-[#38e0c4] hover:bg-[rgba(56,224,196,0.12)] hover:text-[#5ceace]">Book a Free ERP Consultation</Link>
            </div>
          ...
          <div className="relative h-[520px] overflow-hidden rounded-[20px] shadow-[0_24px_64px_rgba(0,0,0,0.45)]">
            <Image src="/assets/erp-advisory-hero.png" alt="ERP advisory working session" fill priority sizes="560px" className="object-cover [object-position:center_40%] [filter:grayscale(0.12)]" />
      ...
      <div className="grid grid-cols-[1.15fr_0.85fr] items-start gap-[64px] px-[64px] pb-[96px]">
          ...
          <div className="grid grid-cols-2 gap-[32px]">
            <div>
              <div className="mb-[10px] flex items-start gap-[10px]">
                ...
                <span className="font-sora text-[16px] font-bold text-[#1c1b1b]">ERP Strategy &amp; Governance</span>
              </div>
            ...
            <div>
              <div className="mb-[10px] flex items-start gap-[10px]">
                ...
                <span className="font-sora text-[16px] font-bold text-[#1c1b1b]">ERP Project Management &amp; Assurance</span>
              </div>
        ...
        <div className="mt-[150px] rounded-[16px] border border-[#E5E7EB] bg-[#f6f3f2] p-[36px]">
          <div className="mb-[24px] flex items-start gap-[14px]">
            ...
            <div>
              <span className="mb-[3px] block font-sora text-[18px] font-bold text-[#1c1b1b]">Integrity Guarantee</span>
      ...
      <div className="px-[64px] py-[96px]">
        ...
        <p className="mx-auto max-w-[1100px] whitespace-nowrap text-center font-inter text-[17px] italic leading-[1.6] text-[#6e7977]">The technology is rarely the cause of failure. The leadership around the technology almost always is.</p>
      </div>

      {/* ===== WHY ERP PROJECTS FAIL ===== */}
      <div className="grid grid-cols-[0.7fr_1.3fr] items-center gap-[40px] px-[64px] pb-[96px]">
        <div>
          ...
          <div className="grid max-w-[420px] grid-cols-2 gap-[28px]">
            {failTiles.map((ft) => (
        ...
        <div className="flex h-full flex-col justify-center self-center">
          {failures.map((f) => (
            <div key={f.lead} className="flex items-start gap-[18px] border-b border-[#E5E7EB] py-[18px]">
              ...
              <p className="font-inter text-[16.5px] leading-[1.6] text-[#3e4947]"><strong className="font-semibold text-[#1c1b1b]">{f.lead}</strong> — {f.rest}</p>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="border-y border-[#E5E7EB] bg-white px-[64px] py-[96px]">
        ...
        <div className="mb-[56px] text-center">
          ...
          <h3 className="font-sora text-[40px] font-bold leading-[1.15] tracking-[-0.02em] text-[#1c1b1b]">Our in-house ERP Delivery Methodology</h3>
        ...
        <div className="relative grid grid-cols-6 gap-[18px]">
          ...
          {stages.map((s) => (
            <div key={s.num} className="relative z-[1] flex flex-col items-center gap-0 text-center">
              <span className="mb-[20px] inline-flex h-[54px] w-[54px] items-center justify-center rounded-full border-[3px] border-white font-jet text-[19px] font-extrabold text-[#eafff8] shadow-[0_6px_16px_rgba(15,118,110,0.28)] [background:linear-gradient(145deg,#0f766e,#0b4f49)]">{s.num}</span>
              <div className="flex w-full flex-1 flex-col gap-[11px] rounded-[14px] border border-[rgba(15,118,110,0.18)] border-t-[3px] border-t-[#17a892] px-[20px] py-[24px] shadow-[0_1px_2px_rgba(0,0,0,0.04)] transition-[transform,box-shadow,border-color] duration-[250ms] hover:-translate-y-[6px] hover:border-[#17a892] hover:shadow-[0_16px_34px_rgba(15,118,110,0.14)] [background:linear-gradient(160deg,rgba(45,212,191,0.10)_0%,rgba(45,212,191,0.03)_40%,#FFFFFF_78%)]">
                <span className="font-sora text-[16.5px] font-bold leading-[1.3] text-[#1c1b1b] [text-wrap:pretty]">{s.name}</span>
      ...
      <div className="px-[64px] py-[96px] text-center">
        ...
        <p className="mx-auto max-w-[760px] font-inter text-[16px] leading-[1.65] text-[#3e4947] [text-wrap:pretty]">Different businesses need different platforms. A 60-user manufacturer in Ruiru is not a 12-partner law firm in Westlands. We govern the selection and implementation logic so the system fits the business, not the other way round.</p>
        <div className="mt-[40px] flex justify-center">
          <Link href={`${routes.erpPitfalls}#self-check`} className="inline-flex items-center gap-[12px] rounded-[12px] bg-[#38e0c4] px-[32px] py-[16px] font-inter text-[16px] font-bold text-[#06231e] shadow-[0_8px_24px_rgba(56,224,196,0.25)] hover:bg-[#5ceace]">Take the two-minute ERP readiness self-check<span className="text-[17px]">→</span></Link>
        </div>
      </div>

      {/* ===== ODOO SPECIALTY ===== */}
      <div className="bg-white px-[64px] pb-[96px] pt-[80px]">
      ...
      {/* ===== PROOF CARDS ===== */}
      <div className="px-[64px] pb-[96px] pt-[80px]">
      ...
      <div className="px-[64px] pb-[96px]">
        <div className="grid grid-cols-[1.3fr_0.7fr] items-center gap-[64px] overflow-hidden rounded-[24px] border border-[rgba(56,224,196,0.16)] bg-[#0c1512] px-[64px] py-[72px] shadow-[inset_0_1px_0_rgba(56,224,196,0.08),0_24px_60px_rgba(0,0,0,0.35)] [background-image:radial-gradient(circle_at_90%_8%,rgba(56,224,196,0.16),transparent_44%),radial-gradient(circle_at_2%_98%,rgba(56,224,196,0.12),transparent_42%),linear-gradient(90deg,rgba(56,224,196,0.05)_1px,transparent_1px),linear-gradient(rgba(56,224,196,0.05)_1px,transparent_1px),linear-gradient(140deg,#10201c_0%,#0c1512_52%,#0a1310_100%)] [background-size:auto,auto,54px_54px,54px_54px,auto]">
          <div>
          ...
          <div className="flex justify-end">
            <Link href={routes.enquiry} className="inline-flex items-center gap-[12px] whitespace-nowrap rounded-[12px] bg-[#38e0c4] px-[30px] py-[18px] font-inter text-[16px] font-bold text-[#0c1512] hover:bg-[#5ceace]">
