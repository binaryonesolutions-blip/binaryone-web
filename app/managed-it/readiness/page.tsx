...
export default function ItReadinessPage() {
  return (
    <div data-skin="corporate" className="mx-auto min-h-screen w-[1440px] bg-[#F8FAFB] font-inter text-[#1c1b1b]">
      {/* Nav */}
      ...
      {/* Intro */}
      <section className="max-w-[860px] px-[64px] pb-[48px] pt-[80px]">
        ...
        <h1 className="mb-[20px] font-sora text-[44px] font-bold leading-[1.12] tracking-[-0.02em] text-[#1c1b1b] [text-wrap:pretty]">Perform a Managed IT Readiness Assessment.</h1>
        <p className="font-inter text-[17px] leading-[1.65] text-[#3e4947] [text-wrap:pretty]">Tell us the shape of your environment. We use these numbers to size the right service pack before your Free IT Assessment — no obligation, no sales pitch.</p>
      </section>

      <ItReadiness />

      {/* Footer strip */}
      <footer className="flex items-center justify-between bg-[#071e1b] px-[64px] py-[32px] font-inter text-[13.5px] text-[#9fbcb7]">
