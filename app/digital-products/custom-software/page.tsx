...
export default function CustomSoftwarePage() {
  return (
    ...
    >
      ...
      {/* Hero */}
      <section className="relative overflow-hidden px-[64px] pb-[84px] pt-[88px] [background:radial-gradient(120%_130%_at_8%_0%,#0a2a24_0%,#071e1b_42%,#06181f_72%,#071627_100%)]">
        ...
        <div className="relative grid grid-cols-[1.08fr_0.92fr] items-center gap-[60px]">
          <div>
            ...
            <h1 className="mb-[26px] font-sora text-[56px] font-bold leading-[1.06] tracking-[-0.025em] text-white [text-wrap:pretty]">
              Off-the-shelf software solves common problems. <span className="text-[#38e0c4]">Custom software creates unfair advantages.</span>
            </h1>
            <p className="mb-[34px] max-w-[560px] font-inter text-[17.5px] leading-[1.65] text-[#aebfba] [text-wrap:pretty]">
          ...
          <div className="group relative overflow-hidden rounded-[18px] border border-[rgba(45,212,191,0.22)] bg-[#05100e] shadow-[0_34px_80px_rgba(0,0,0,0.55)]">
      ...
      <section className="border-t border-white/10 px-[64px] py-[88px]">
        <h2 className="mb-[48px] font-sora text-[38px] font-bold leading-[1.15] tracking-[-0.02em] text-white">The Build vs Buy framework.</h2>
        <table className="mb-[36px] w-full border-collapse">
          <thead>
            <tr>
        ...
        <div className="flex items-start gap-[24px] rounded-[16px] border border-[rgba(124,220,121,0.35)] bg-[rgba(124,220,121,0.06)] px-[36px] py-[32px]">
          ...
          <div className="flex flex-col">
            <p className="mb-[10px] font-inter text-[19px] font-semibold text-[#7cdc79]">Rule of thumb: if you tick fewer than four BUILD boxes, do not build. We will tell you so.</p>
      ...
      {/* What we build */}
      <section className="border-t border-white/10 px-[64px] py-[88px]">
        <h2 className="mb-[48px] font-sora text-[38px] font-bold leading-[1.15] tracking-[-0.02em] text-white">What we build.</h2>
        <div className="grid grid-cols-4 gap-[20px]">
          {builds.map((b) => (
            <div key={b.num} className="relative flex flex-col gap-[10px] overflow-hidden rounded-[16px] border border-[rgba(148,163,184,0.16)] bg-[#10263F] p-[26px] [background-image:radial-gradient(120%_90%_at_15%_0%,rgba(45,212,191,0.16)_0%,rgba(45,212,191,0.05)_38%,transparent_68%)] hover:border-[rgba(45,212,191,0.5)]">
              ...
              <span className="relative font-inter text-[16.5px] font-semibold leading-[1.35] text-white">{b.name}</span>
      ...
      <section className="border-t border-white/10 px-[64px] py-[88px]">
        <div className="mb-[44px] flex flex-col items-start gap-[16px]">
          ...
          <h2 className="font-sora text-[38px] font-bold leading-[1.15] tracking-[-0.02em] text-white">The delivery model.</h2>
      ...
      {/* Engineering stack */}
      <section className="grid grid-cols-2 items-center gap-[64px] border-t border-white/10 px-[64px] py-[88px]">
        <div>
          <span className="mb-[20px] block font-jet text-[13px] font-medium tracking-[0.18em] text-[#7cdc79]">CLEAN ENGINEERING</span>
          <h2 className="mb-[22px] font-sora text-[38px] font-bold leading-[1.2] tracking-[-0.02em] text-white [text-wrap:pretty]">Our engineering stack: modern, fast and maintainable.</h2>
          <p className="mb-[28px] font-inter text-[16.5px] leading-[1.7] text-[#94A3B8] [text-wrap:pretty]">We construct solutions that are secure, scalable and cost-effective. We avoid legacy bloat and vendor lock-in by utilising open standards:</p>
          ...
          <p className="font-inter text-[16px] font-semibold leading-[1.6] text-[#7cdc79] [text-wrap:pretty]">We do not have a stack to sell you. We have an outcome to deliver.</p>
        </div>
        <div className="rounded-[18px] border border-[rgba(59,130,246,0.3)] bg-[#10263F] px-[34px] pb-[26px] pt-[34px]">
          <h3 className="mb-[22px] font-sora text-[20px] font-bold tracking-[-0.01em] text-white">Standards &amp; Technologies</h3>
      ...
      <section className="px-[64px] pb-[88px]">
        <div className="relative grid grid-cols-[1.5fr_auto] items-center gap-[48px] overflow-hidden rounded-[20px] border border-[rgba(56,224,196,0.16)] px-[56px] py-[52px] shadow-[inset_0_1px_0_rgba(56,224,196,0.08),0_24px_60px_rgba(0,0,0,0.35)] [background-color:#0c1512] [background-image:radial-gradient(circle_at_90%_8%,rgba(56,224,196,0.16),transparent_44%),radial-gradient(circle_at_2%_98%,rgba(56,224,196,0.12),transparent_42%),linear-gradient(90deg,rgba(56,224,196,0.05)_1px,transparent_1px),linear-gradient(rgba(56,224,196,0.05)_1px,transparent_1px),linear-gradient(140deg,#10201c_0%,#0c1512_52%,#0a1310_100%)] [background-size:auto,auto,54px_54px,54px_54px,auto]">
          <div className="relative">
            <span className="mb-[14px] block font-jet text-[12.5px] font-semibold tracking-[0.18em] text-[#7cdc79]">SCOPING PROGRAM</span>
            <h2 className="mb-[16px] font-sora text-[32px] font-bold leading-[1.2] tracking-[-0.02em] text-white">Bring your technical roadmap to life.</h2>
          ...
          <Link href={routes.enquiry} className="relative inline-flex items-center gap-[10px] whitespace-nowrap rounded-[12px] bg-[#38e0c4] px-[28px] py-[16px] font-inter text-[15.5px] font-bold text-[#0c1512] transition-colors hover:bg-[#5ceace] hover:text-[#0c1512]">
      ...
      {/* Final CTA */}
      <section className="border-t border-white/10 px-[64px] py-[96px] text-center">
        <h2 className="mx-auto mb-[36px] max-w-[720px] font-sora text-[40px] font-bold leading-[1.2] tracking-[-0.02em] text-white">Build the things worth building.</h2>
        <Link href={routes.enquiry} className="relative inline-block overflow-hidden rounded-[12px] bg-[#38e0c4] px-[32px] py-[16px] font-inter text-[16.5px] font-bold text-[#06231e] transition-colors hover:bg-[#5eead4] hover:text-[#06231e]">
