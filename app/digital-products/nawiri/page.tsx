...
export default function NawiriPage() {
  return (
    <div
      data-skin="nawiri"
      className="mx-auto w-[1440px] bg-[#0A1628] font-inter text-white [background-image:linear-gradient(rgba(45,212,191,0.05)_1px,transparent_1px),linear-gradient(90deg,rgba(45,212,191,0.05)_1px,transparent_1px)] [background-size:48px_48px]"
    >
      <NawiriNav />

      {/* Hero */}
      <section className="grid grid-cols-[1.05fr_0.95fr] items-center gap-[56px] px-[64px] pb-[56px] pt-[96px]">
        <div>
          ...
          <p className="mb-[36px] font-inter text-[18px] leading-[1.65] text-[#94A3B8] [text-wrap:pretty]">
          ...
          <div className="flex items-center gap-[20px]">
            <Link href={routes.nawiriSelfScore} className="inline-block rounded-[12px] bg-[#9EFF5A] px-[30px] py-[16px] font-sora text-[16px] font-bold text-[#0A1628] shadow-[0_0_32px_rgba(158,255,90,0.25)] transition-colors hover:bg-[#B4FF7E] hover:text-[#0A1628]">
        ...
        <div className="relative flex h-[440px] items-center justify-center overflow-hidden rounded-[16px] border border-[rgba(45,212,191,0.35)] bg-[#11203A] shadow-[0_24px_64px_rgba(0,0,0,0.4)]">
          <Image src={nawiriRetail} alt="Kenyan retail loyalty moment" fill sizes="620px" className="object-cover [object-position:center_45%]" />
        </div>
      </section>

      {/* Trust strip */}
      <section className="flex flex-wrap gap-[10px] px-[64px] pb-[88px]">
        {trustChips.map((chip) => (
      ...
      <section className="border-t border-[rgba(45,212,191,0.2)] px-[64px] py-[88px]">
        <span className="mb-[16px] block font-jet text-[12px] font-medium tracking-[0.18em] text-[#2dd4bf]">LOYALTY HAS CHANGED</span>
        <h2 className="mb-[20px] max-w-[820px] font-sora text-[38px] font-extrabold leading-[1.15] text-white [text-wrap:pretty]">
          Loyalty is no longer a retention gimmick. It is a <span className="text-[#9EFF5A]">real-time data channel.</span>
        </h2>
        <p className="mb-[56px] max-w-[820px] font-inter text-[16.5px] leading-[1.65] text-[#94A3B8] [text-wrap:pretty]">
        ...
        <div className="relative pt-[24px]">
          ...
          <div className="relative grid grid-cols-4 gap-[20px]">
            {eras.map((era) => (
              <div key={era.num} className="flex flex-col">
                ...
                <div className="relative flex flex-1 flex-col gap-[14px] rounded-[16px] px-[26px] pb-[24px] pt-[26px]" style={{ background: era.cardBg, border: `1px solid ${era.cardBorder}`, boxShadow: era.cardShadow }}>
                  ...
                  <span className="absolute right-[18px] top-[10px] font-sora text-[44px] font-extrabold leading-[1]" style={{ color: era.ghost }}>{era.num}</span>
                  ...
                  <span className="font-sora text-[19px] font-extrabold leading-[1.25] text-white">{era.name}</span>
      ...
      <section className="border-t border-[rgba(45,212,191,0.2)] px-[64px] py-[88px] [background:linear-gradient(180deg,rgba(45,212,191,0.045),rgba(45,212,191,0.015))]">
        ...
        <div className="grid grid-cols-[360px_1fr] items-start gap-[40px]">
          ...
          <div className="flex flex-col">
            {failures.map((f) => (
              <div key={f} className="flex items-start gap-[18px] border-b border-[rgba(45,212,191,0.2)] py-[20px]">
                ...
                <p className="font-inter text-[16.5px] leading-[1.6] text-[#E2E8F0]">{f}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* Features */}
      <section id="features" className="border-t border-[rgba(45,212,191,0.2)] px-[64px] py-[88px] [scroll-margin-top:78px]">
        <span className="mb-[16px] block font-jet text-[12px] font-medium tracking-[0.18em] text-[#2dd4bf]">NAWIRI PLATFORM</span>
        <h2 className="mb-[56px] font-sora text-[38px] font-extrabold leading-[1.15] text-white">Eight capabilities. <span className="text-[#9EFF5A]">One platform.</span></h2>
        <div className="grid grid-cols-4 gap-[20px]">
          {features.map((ft) => (
            <div key={ft.num} className="flex flex-col gap-[12px] rounded-[16px] border border-[rgba(45,212,191,0.32)] bg-[#11203A] p-[28px] [background-image:radial-gradient(130%_100%_at_12%_0%,rgba(45,212,191,0.14)_0%,rgba(45,212,191,0.04)_42%,transparent_70%)] hover:border-[rgba(45,212,191,0.6)]">
              ...
              <span className="font-sora text-[17px] font-bold leading-[1.3] text-white">{ft.name}</span>
      ...
      {/* Proof */}
      <section id="proof" className="border-t border-[rgba(45,212,191,0.2)] px-[64px] py-[88px] [scroll-margin-top:78px] [background:linear-gradient(180deg,rgba(45,212,191,0.045),rgba(45,212,191,0.015))]">
        <div className="mb-[56px] grid grid-cols-[auto_1fr] items-center gap-[80px]">
          ...
          <p className="max-w-[540px] font-inter text-[18px] leading-[1.65] text-[#E2E8F0] [text-wrap:pretty]">Prototype to live deployment possible within two months, subject to scope and readiness.</p>
        </div>
        <div className="grid grid-cols-3 gap-[20px]">
          <div className="flex flex-col gap-[14px] rounded-[16px] border border-[rgba(45,212,191,0.3)] bg-[#11203A] p-[32px]">
            <div className="flex items-center gap-[12px]">
              ...
              <span className="font-sora text-[19px] font-bold text-[#9EFF5A]">Crown Paints Team Kubwa</span>
            </div>
          ...
          <div className="flex flex-col gap-[14px] rounded-[16px] border border-[rgba(45,212,191,0.3)] bg-[#11203A] p-[32px]">
            <div className="flex items-center gap-[12px]">
              ...
              <span className="font-sora text-[19px] font-bold text-[#9EFF5A]">Isuzu MAXIT</span>
            </div>
          ...
          <div className="flex flex-col gap-[14px] rounded-[16px] border border-[rgba(45,212,191,0.3)] bg-[#11203A] p-[32px]">
            <div className="flex items-center gap-[12px]">
              ...
              <span className="font-sora text-[19px] font-bold text-[#9EFF5A]">Sector breadth</span>
            </div>
      ...
      {/* Pricing position */}
      <section id="pricing" className="border-t border-[rgba(45,212,191,0.2)] px-[64px] py-[88px] [scroll-margin-top:78px]">
        <div className="grid grid-cols-[auto_380px_1fr] items-center gap-[56px]">
          <div className="flex flex-col gap-[6px]">
            ...
            <span className="whitespace-nowrap font-caveat text-[38px] font-bold leading-[1.1] text-[#2dd4bf]">
          ...
          <div className="rounded-[16px] border border-[rgba(45,212,191,0.3)] bg-[#11203A] p-[36px]">
            <p className="font-inter text-[17px] leading-[1.7] text-[#E2E8F0] [text-wrap:pretty]">NAWIRI is sold as a white-labelled SaaS subscription with a fixed setup fee and monthly platform fee scaled to active members and reward volume. <strong className="font-bold text-[#9EFF5A]">We do not take a cut of your rewards budget. You own your data.</strong></p>
          </div>
        </div>
      </section>

      {/* Final CTA */}
      <section id="demo" className="border-t border-[rgba(45,212,191,0.2)] px-[64px] py-[112px] text-center [scroll-margin-top:78px] [background:radial-gradient(60%_100%_at_50%_0%,rgba(158,255,90,0.08),rgba(158,255,90,0)_70%)]">
        <h2 className="mx-auto mb-[40px] max-w-[780px] font-sora text-[44px] font-extrabold leading-[1.15] text-white [text-wrap:balance]">Ready to own the last mile of <span className="text-[#9EFF5A]">your market?</span></h2>
        <div className="flex items-center justify-center gap-[24px]">
          <Link href={routes.enquiry} className="inline-block rounded-[12px] bg-[#9EFF5A] px-[34px] py-[17px] font-sora text-[16.5px] font-bold text-[#0A1628] shadow-[0_0_40px_rgba(158,255,90,0.3)] transition-colors hover:bg-[#B4FF7E] hover:text-[#0A1628]">Book a NAWIRI Demo</Link>
      ...
      {/* Footer strip */}
      <footer className="flex items-center justify-between border-t border-[rgba(45,212,191,0.25)] px-[64px] py-[32px] font-inter text-[13.5px] text-[#94A3B8]">
